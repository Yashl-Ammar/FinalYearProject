        ...
        if (data && data?.basic?.offerDetails?.length > 0){            
            return data.basic?.offerDetails.map((val,index) => {
                return <div className="flex items-center mb-5">
                        ...
                        <p key={index} className="text-lg font-bold text-lightGray">{val}</p>
                    </div>
            })
        }
    ...
    <div className="w-4/5">
        ...
        <div className="flex w-full flex-col lg:flex-row">
            <div className="w-full lg:w-2/3 lg:pr-5 mb-10">
                ...
                <p className="text-lightGray font-bold text-lg mb-7">Starting at <span className="text-white">$ {data?.basic?.price}</span></p>
            ...
            <div className="flex flex-col w-full lg:w-1/3 mb-10">
                <div className="rounded-lg border border-white px-7 py-5 mb-7">
                    ...
                    navigate('/general/messaging')
                }} />
                </div>
                <div className="rounded-lg border border-white px-7 py-5">
        ...
        <div className="bg-aamdanSuperDeepBlack">
            <div className="flex">
                <button className={`w-full ${selectedPackage === 'basic' ? 'bg-aamdanBackground': 'bg-aamdanDeepBlack'} py-4`} onClick={() => {setSelectedPackage('basic')}}>Basic</button>
                <button className={`w-full ${selectedPackage === 'standard' ? 'bg-aamdanBackground': 'bg-aamdanDeepBlack'} border-x-aamdanBackground border-x py-4`} onClick={() => {setSelectedPackage('standard')}}>Standard</button>
                <button className={`w-full ${selectedPackage === 'premium' ? 'bg-aamdanBackground': 'bg-aamdanDeepBlack'} py-4`} onClick={() => {setSelectedPackage('premium')}}>Premium</button>
            </div>
            <hr />
            {selectedPackage === 'basic' &&<div className="mb-10 px-5 lg:px-20 py-10">
                ...
                <p className="font-bold text-lg text-lightGray mb-7">{data?.basic?.detail}</p>
                <div className="flex mb-7">
                    <img className="mr-16" src="/Delivery Time.svg" alt="" />
                    <p className="font-bold text-lightGray text-lg">{data.basic?.time} Days Delivery</p>
                </div>
                <div className="flex mb-10">
                    <img className="mr-16 w-10" src="/Repeat.svg" alt="" />
                    <p className="font-bold text-lightGray text-lg">{data.basic?.revisions} Revisions</p>
                </div>
                <div className="mb-8">
            ...
            {selectedPackage === 'standard' &&<div className="mb-10 px-5 lg:px-20 py-10">
                ...
                <p className="font-bold text-lg text-lightGray mb-7">{data?.standard?.detail}</p>
                <div className="flex mb-7">
                    <img className="mr-16" src="/Delivery Time.svg" alt="" />
                    <p className="font-bold text-lightGray text-lg">{data.standard?.time} Days Delivery</p>
                </div>
                <div className="flex mb-10">
                    <img className="mr-16 w-10" src="/Repeat.svg" alt="" />
                    <p className="font-bold text-lightGray text-lg">{data.standard?.revisions} Revisions</p>
                </div>
                <div className="mb-8">
                    <p className="font-bold text-lg mb-7">What you will receive</p>
                    {mapStandardBullets()}
            ...
            {selectedPackage === 'premium' &&<div className="mb-10 px-5 lg:px-20 py-10">
                ...
                <p className="font-bold text-lg text-lightGray mb-7">{data?.premium?.detail}</p>
                <div className="flex mb-7">
                    <img className="mr-16" src="/Delivery Time.svg" alt="" />
                    <p className="font-bold text-lightGray text-lg">{data.premium?.time} Days Delivery</p>
                </div>
                <div className="flex mb-10">
                    <img className="mr-16 w-10" src="/Repeat.svg" alt="" />
                    <p className="font-bold text-lightGray text-lg">{data.premium?.revisions} Revisions</p>
                </div>
                <div className="mb-8">
                    <p className="font-bold text-lg mb-7">What you will receive</p>
                    {mapPremiumBullets()}
