            ...
            <div className="rounded-xl sm:px-11 sm:py-14 sm:bg-aamdanDeepBlack">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="w-full mb-14">
                        <p className="text-lightGrayWhite dark:text-lightGray mb-3">1/4</p>
                        ...
                        <div className="flex items-center justify-between w-full mb-4">
                            ...
                            <p className={`${watchTitle?.length > 80 ? 'text-red' : 'text-lightGrayWhite dark:text-lightGray ' }`}>{watchTitle ? watchTitle.length : 0}/80</p>
                        </div>
                    ...
                    <div className="w-full mb-14">
                        ...
                        <div className="flex items-center justify-between w-full mb-4">
                            ...
                            <p className={`${watchDescription?.length > 800 ? 'text-red' : 'text-lightGrayWhite dark:text-lightGray ' }`}>{watchDescription ? watchDescription.length : 0}/800</p>
                        </div>
