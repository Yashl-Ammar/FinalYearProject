...
function ViewYourProposalsPage() {
    ...
    <div className="w-full lg:w-4/5">
        ...
        <div className="bg-white dark:bg-aamdanSuperDeepBlack rounded-xl w-full sm:px-12 py-9">
            <div className="px-12 sm:px-0">
                ...
                <div className="hidden sm:flex mb-12">
                    <div className="w-full lg:w-1/5 text-center">
                        <p className="text-lg font-bold mb-3 px-5" onClick={() => {setSelectedFilter('best')}}><Link>Active Proposals</Link></p>
                        <div className={`w-full ${selectedFilter === 'best' ? 'bg-white dark:bg-aamdanBackground' : 'bg-aamdanBackground dark:bg-white'}`} style={{height:'1px'}} ></div>
                    </div>
                    <div className="w-full lg:w-1/5 text-center">
                        <p className="text-lg font-bold mb-3 px-5" onClick={() => {setSelectedFilter('pinned')}}><Link>Pinned proposals</Link></p>
                        <div className={`w-full ${selectedFilter === 'pinned' ? 'bg-white dark:bg-aamdanBackground' : 'bg-aamdanBackground dark:bg-white'}`} style={{height:'1px'}} ></div>
                    </div>
